@extends('components.public.matrix', ['pagina' => 'Libro de reclamaciones'])
...
@section('content')
  <section class="text-white px-[5%] lg:px-[8%] font-gotham_book pt-10" style="background-image:url({{asset('images/img/texturanosotros.png')}})">
    @if ($errors->has('g-recaptcha-response'))
      <span class="help-block">
        <strong>{{ $errors->first('g-recaptcha-response') }}</strong>
      </span>
    @endif
    <h2 class="col-span-4 font-bold  text-4xl leading-none md:leading-tight text-center pt-3 font-gotham_bold">Libro de Reclamaciones</h2>
    <form class="flex flex-col gap-5" id="formLibroReclamo" action="" method="POST" enctype='multipart/form-data'>
      <div class=" my-16 grid grid-cols-1  lg:grid-cols-4 gap-5 justify-center items-center">
        ...
        <div class="flex flex-col col-span-4 lg:col-span-2 gap-2">
          <label for="fullname" class="font-medium text-[12px] text-white">Nombre</label>
          <input id="fullname" type="text" placeholder="Nombre Completo" required name="fullname"
            class="w-full py-3 px-4 focus:outline-none placeholder-gray-600 font-normal text-[16px] border-[1.5px] border-gray-200 rounded-xl text-[#44484a]" />
        </div>


        <div class="flex flex-col col-span-4 lg:col-span-1 gap-2">
          <label for="type_document" class="font-medium text-[12px] text-white">Tipo de documento</label>
        ...
        <div class="flex flex-col col-span-4 lg:col-span-1 gap-2">
          <label for="number_document" class="font-medium text-[12px] text-white">Numero de indentidad</label>
          <input id="number_document" type="text" placeholder="Numero de indentidad" required name="number_document"
            class="w-full py-3 px-4 focus:outline-none placeholder-gray-600 font-normal text-[16px] border-[1.5px] border-gray-200 rounded-xl text-[#44484a]" />
        </div>

        <div class="flex flex-col col-span-4 lg:col-span-2 gap-2">
          <label for="cellphone" class="font-medium text-[12px] text-white">Celular</label>
          <input id="cellphone" type="text" placeholder="Numero celular" required name="cellphone"
            class="w-full py-3 px-4 focus:outline-none placeholder-gray-600 font-normal text-[16px] border-[1.5px] border-gray-200 rounded-xl text-[#44484a]" />
        </div>

        <div class="flex flex-col col-span-4 lg:col-span-2 gap-2">
          <label for="email" class="font-medium text-[12px] text-white">Correo
            Electrónico</label>
          <input type="email" placeholder="hola@gmail.com" required name="email" id="email"
            class="w-full py-3 px-4 focus:outline-none placeholder-gray-600 font-normal text-[16px] border-[1.5px] border-gray-200 rounded-xl" />
        </div>

        <div class="flex flex-col col-span-4 lg:col-span-2 gap-2">
          <label for="department" class="font-medium text-[12px] text-white">Departamento</label>
        ...
        <div class="flex flex-col col-span-4 lg:col-span-1 gap-2">
          <label for="province" class="font-medium text-[12px] text-white">Provincia</label>
        ...
        <div class="flex flex-col col-span-4 lg:col-span-1 gap-2">
          <label for="district" class="font-medium text-[12px] text-white">Distrito</label>
        ...
        <div class="flex flex-col col-span-4 gap-2">
          <label for="address" class="font-medium text-[12px] text-white">Direccion</label>
        ...
        <div class="flex flex-col col-span-4 gap-2">
          <label for="typeitem" class="font-medium text-[12px] text-white">¿Fue un producto o
            Servicio?</label>
        ...
        <div class="flex flex-col col-span-4 lg:col-span-2 gap-2">
          <label for="amounttotal" class="font-medium text-[12px] text-white">Monto reclamado</label>
          <input id="amounttotal" type="text" placeholder="Monto total reclamado" required name="amounttotal"
            class="w-full py-3 px-4 focus:outline-none placeholder-gray-600 font-normal text-[16px] border-[1.5px] border-gray-200 rounded-xl text-[#44484a]" />
        </div>

        {{-- <div class="flex flex-col col-span-4 lg:col-span-1 gap-2">
                    <label for="category_product_service" class="font-medium text-[12px] text-[#44484a]">Tipo de
                        bien</label>
        ...
        <div class="flex flex-col col-span-4 lg:col-span-2 gap-2">
          <label for="description" class="font-medium text-[12px] text-white">Descripcion de
            producto</label>
        ...
        <div class="flex flex-col col-span-4 gap-2">
          <label for="type_claim" class="font-medium text-[12px] text-white">¿Es un reclamo o queja?</label>
        ...
        <div class="flex flex-col col-span-4 lg:col-span-2 gap-2">
          <label for="date_incident" class="font-medium text-[12px] text-white">Fecha de ocurrencia</label>
          <input id="date_incident" type="date" placeholder="Provincia" required name="date_incident"
            class="w-full py-3 px-4 focus:outline-none placeholder-gray-600 font-normal text-[16px] border-[1.5px] border-gray-200 rounded-xl text-[#44484a]" />
        </div>

        <div class="flex flex-col col-span-4 lg:col-span-2 gap-2">
          <label for="address_incident" class="font-medium text-[12px] text-white">Numero de Pedido</label>
        ...
        <div class="flex flex-col col-span-4 gap-2">
          <label for="detail_incident" class="font-medium text-[12px] text-white">Detalle de reclamo o
            queja</label>
        ...
        <div class="flex flex-row col-span-4 gap-2 ">
          ...
          <label for="termsandconditions" class="font-medium text-sm text-white">Estoy de acuerdo con los <a
              class="font-bold" id="linkTerminos2">terminos y condiciones</a></label>

        </div>
        {{-- <div class="flex flex-col col-span-4 gap-2">
                    <label for="archivo" class="font-medium text-[12px] text-[#44484a]">Adjuntar archivos
                        (opcional)</label>
        ...
        <div class="flex flex-row col-span-2 gap-2 ">
          <input type="submit" value="Enviar a libro de reclamaciones" id="btnAjax"
            class="col-span-4 text-white bg-[#E29720] py-3 rounded-2xl cursor-pointer border-2 font-semibold text-[16px] text-center border-none w-full md:w-auto px-10 inline-block" />
        </div>
