        ...
        <section  class="bg-cover bg-center pt-16"  style="background-image:url({{asset('images/img/texturanosotros.png')}})">
            ...
            <section class="flex flex-col justify-start items-start px-[5%] py-10 lg:py-12 relative max-w-4xl mx-auto">
                ...
                <div class="grid grid-cols-1">
                    ...
                    <form action="{{ route('appeal.save') }}" method="POST"  class="w-full" enctype="multipart/form-data"
                        x-data="{
                            paso: 1,
                            ...
                            validateStep2() {
                                ...
                                this.errorsStep2.resolution = !this.resolution;
                    ...
                    >
                        ...
                        <div x-show="paso === 2" x-transition class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <h2 class="md:col-span-2 text-white font-gotham_book font-semibold text-lg">Datos de la apelación</h2>
                            ...
                            <div class="relative">
                                <label for="resolution" class="font-gotham_book text-sm text-white">Recurso de apelación contra la Resolución N°</label>
                                <input x-model="resolution" @input="errorsStep2.resolution = false" type="text" name="resolution" id="resolution" placeholder="" 
                                    class="mt-1.5 p-2 rounded bg-white bg-opacity-10 text-white font-gotham_book w-full focus:border-white focus:ring-0 placeholder:text-white placeholder:text-opacity-60">
                                <span x-show="errorsStep2.resolution" class="text-red-300 text-xs 2xl:text-base mt-1 block font-gotham_book">
                                    Por favor ingrese el número de resolución
                                </span>
                            </div>

                            <div class="md:col-span-2 relative">
                                <label for="claim_issue" class="font-gotham_book text-sm text-white">Motivo de apelación</label>
                                <div class="flex flex-col mt-1.5">
                                    <select  x-model="claim_issue" name="claim_issue" id="claim_issue" placeholder="Seleccione" 
                                        ...
                                        <option value="Otros defectos de tramitación">No se analizaron pruebas presentadas por el usuario</option>
                                        <option value="La carta no motiva o sustenta la decisión de la empresa sobre el reclamo">La carta no motiva o sustenta la decisión de la empresa sobre el reclamo</option>
                                        <option value="Empresa operadora emitió pronunciamiento por materia distinta a la reclamada">Empresa operadora emitió pronunciamiento por materia distinta a la reclamada</option>
                                        <option value="Empresa omitió pronunciarse por un extremo del reclamo o un recibo reclamado">Empresa omitió pronunciarse por un extremo del reclamo o un recibo reclamado</option>
                                        <option value="La empresa operadora no acogió toda su pretensión">La empresa operadora no acogió toda su pretensión</option>
                                        <option value="Otros">Otros</option>
                                    </select>
                                    <span x-show="errorsStep2.claim_issue" class="text-red-300 text-xs 2xl:text-base mt-1 block font-gotham_book">
                                        Por favor seleccione el motivo de apelación
                                    </span>
                                </div>
                            </div>
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            Swal.fire({
                                ...
                                html: `Tu apelacion ha sido registrada correctamente.<br><br>
                                    <strong>Número de apelacion:</strong> ${response.appeal_number}.<br><br>
                                    `,
                                confirmButtonText: 'Aceptar'
                            }).then((result) => {
                                // Redirigir a página de éxito o recargar
                                window.location.href = '/apelacion-exitoso?numero=' + response.appeal_number;
                            });
                        } else {
