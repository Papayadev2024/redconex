...
@section('content')
    ...
    <section  class="bg-cover bg-center pt-16"  style="background-image:url({{asset('images/img/texturanosotros.png')}})">
        ...
        <section class="flex flex-col justify-start gap-3 items-start px-[5%] py-10 lg:py-12 relative max-w-4xl mx-auto">
            <h2 class="text-white font-gotham_light font-semibold text-base 2xl:text-lg">Hola, {{ $claim->name_legal ?? 'Usuario' }} Tu queja se ha enviado con éxito.</h2>
            <p class="text-white font-gotham_light text-base 2xl:text-lg">Acá te dejamos el código de tu solicitud: <span class="text-lg font-semibold">{{ $claim->complaint_number }}</span> para que puedas consultar el estado de tu caso al llamar a cualquiera de nuestras líneas de atención al cliente.</p>
