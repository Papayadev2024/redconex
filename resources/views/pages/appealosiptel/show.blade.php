    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div
          ...
          <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
            <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-2xl">Apelacion N° {{ $message->appeal_number }}</h2>
          </header>
          <div class="p-3">
            ...
            <div class="p-6">
                <table class="table-auto w-full border-collapse border border-gray-300 mb-8 text-sm">
                    ...
                    <tr>
                        <td class="font-bold border px-4 py-2">Dirección Instalación detallada:</td>
                    ...
                    <tr>
                        <td class="font-bold border px-4 py-2">Codigo de reclamo</td>
                        <td class="border px-4 py-2">{{ $message->claim_number ?? '---'}}</td>
                        <td class="font-bold border px-4 py-2">N° de Resolución</td>
                        <td class="border px-4 py-2">{{ $message->resolution ?? '---'}}</td>
                    </tr>
                </table>
                
    
              <a href="{{ route('apelacion.index') }}" class="bg-blue-500 px-4 py-2 rounded text-white "><span><i
