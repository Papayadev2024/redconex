                                ...
                                <div id='general' class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 ">
                                    ...
                                    <div class="md:col-span-2 flex flex-row flex-4 justify-center items-center">
                                        <label class="inline-flex items-center cursor-pointer mb-2">
                                          <input id="liquidacion" name="liquidacion" type="checkbox" class="sr-only peer" {{ $product->liquidacion ? 'checked' : '' }}>
                                          <div
                        ...
                        <div class="basis-full md:basis-2/5">
                            ...
                            <div
                                ...
                                <div class="md:col-span-2">
                                    <label>Imagen principal </label>
                                    <div
                                        class="h-40 mt-2 py-2 flex flex-row justify-center border items-center border-gray-300 rounded-xl bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                                        <img src="{{ asset($product->url_fichatecnica.$product->name_fichatecnica) }}" alt=""
                                            class="w-24 rounded-xl object-contain">
                                    </div>
                                </div>
